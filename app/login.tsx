...
export default function Login() {
  ...
  const styles = StyleSheet.create({
    ...
    header: { fontSize: 34, color: COLORS.text, fontWeight: "800" },
    sub: { color: COLORS.muted, fontSize: 16, marginBottom: 28 },
    input: {
    ...
    link: { marginTop: 20 },
    linkText: { color: COLORS.primary, textAlign: "center", fontWeight: "700" },
    toggleBox: { position: "absolute", top: 60, right: 28 },
    toggleTrack: {
      width: 50,
      height: 28,
      borderRadius: 14,
